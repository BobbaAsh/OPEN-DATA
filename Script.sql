...
nombrePeriodesEtablissement INTEGER(2) COMMENT "Nombre de périodes de l’établissement",
complementAdresseEtablissement VARCHAR(38) COMMENT "Complément d’adresse",
numeroVoieEtablissement INTEGER(4) COMMENT "Numéro de voie",
...
numeroVoie2Etablissement  INTEGER(4) COMMENT "Numéro de la voie de l’adresse secondaire",
